...
In additionally to exhaustively testing functional forms and getting similar results, I also obtain extremely similar results when I test only subsets on the data. For instance 
...
Amongst the four branches of the military, the deaths in Iraq and Afghanistan have been highly concentrated amongst soldiers in the Army and the Marines. In the data used in this paper, roughly 2000
