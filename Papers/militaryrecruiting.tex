...
however, recruiters may change their level of effort. FOIA requests for data on recruiter quotas unfortunately have not been granted, so I am only able to use the number of recruiters by state and quarter until halfway through 2004\footnote{I am grateful to John Warner for sharing this data.}, which I have included this extra control variable for that portion of the sample. I also have detailed mortality data, through 2004. It is conceivable that deaths unrelated to
