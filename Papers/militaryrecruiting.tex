...
Since I lack reliable data on military occupational specialties, I can compare the number of
...
\begin{figure}
\includegraphics[scale=0.6]{../Output/PDF/histall4}
...
\pagebreak{}
\begin{figure}
\includegraphics[scale=0.6]{../Output/PDF/hist_binomial}
...
%RECRUITER AND MORTALITY CONTROLS-DO IN LOG LINEAR!!!
\clearpage{}
\pagebreak{}
\begin{table}
...
%MEDIA MARKET AND CONTIGUOUS-DO IN LOG LINEAR!!
\pagebreak{}
\begin{table}
\caption{DO IN LOG LINEAR!!!}
...
\begin{table}
\caption{DO IN LOG LINEAR!!}
\label{Flo:Cumulative Lags}\includegraphics[bb=45bp 0bp 612bp 730bp,clip, scale=0.91]{../Output/PDF/redefrunninglagsP}
\end{table}
...
\begin{table}
\caption{}
\label{Flo: Recs by Quality}\includegraphics[bb=45bp 0bp 612bp 730bp,clip, scale=0.95]{../Output/PDF/highqualitybytypeP}
\end{table}
...
\includegraphics[bb=45bp 0bp 612bp 730bp, scale=0.95]{../Output/PDF/redefPwar}
\end{table}
...
In addition to testing every recruit, I also test the model by using only deaths from active duty soldiers, as opposed to deaths of all soldiers (active, reserve, and guard) as in all other specification. Results, shown in Table~\ref{Flo:Rdeathslinear} appear slightly stronger, in that deterrent effects of in-county deaths are estimated to be slightly larger than one percent. Table~\ref{RdeathsP} shows Poisson regressions using only active duty deaths.
...
\begin{table}
\caption{}
\label{Flo:Poisson Basic}\includegraphics[bb=45bp 0bp 612bp 730bp,clip,scale=0.91]{../Output/PDF/redefPbasic}
\end{table}
...
\caption{}
\label{Flo:RdeathsP}
\includegraphics[bb=45bp 0bp 612bp 730bp,clip,scale=0.95]{../Output/PDF/redefPbasicR}
\end{table}
...
\label{Flo:redefPF1}
\includegraphics[bb=45bp 0bp 612bp 730bp,clip,scale=0.95]{../Output/PDF/redefPF1}
\end{table}
...
\includegraphics[bb=45bp 0bp 692bp 780bp,clip,scale=1.0]{../Output/PDF/redefPbasic90}
\end{table}
