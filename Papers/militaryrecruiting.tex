...
fixed effects are included. The estimates are larger than in this restricted time period than in the full sample, but the effect of a death does not change very much when I add the extra controls. %The estimates for contracts are only
