...
\scalebox{0.8}{\input{../Output/runninglagsLN}}
\end{table}
...
\scalebox{0.7}{\rotatebox{90}{\input{../Output/highqualitybytypeLN}}}
\end{table}
...
have taken at least some college courses. There are fewer observations in this specification since 666 counties never have a very high quality recruit and cannot be included. The results indicate that all but the Very High Quality recruits have roughly the same response to deaths: a slightly smaller than 1\% reduction in recruits for every
...
\begin{table}
\caption{DO IN LOG LINEAR!!}
\label{Flo:Cumulative LagsP}\includegraphics[bb=45bp 0bp 612bp 730bp,clip, scale=0.91]{../Output/PDF/redefrunninglagsP}
\end{table}
...
\begin{table}
\caption{}
\label{Flo: Recs by QualityP}\includegraphics[bb=45bp 0bp 612bp 730bp,clip, scale=0.95]{../Output/PDF/highqualitybytypeP}
\end{table}
