...
*xtpoisson active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty countyunemp monthfe3-monthfe58 statetrend1-statetrend51, fe exposure(avgcountypop) vce(robust)
...
/*DEATH POLYNOMIAL*/
*xtpoisson active `type'monthcountydeath L1`type'monthcountydeath L1`type'monthcountydeathSQ `type'outofcounty L1`type'outofcounty L1`type'outofcountySQ stateunemp countyunemp monthfe3-monthfe58 statetrend1-statetrend51, fe exposure(avgcountypop) vce(robust)
...
/*
disp "HORSE RACE BTW DEATH TYPES%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
xtpoisson monthcountyrecruit `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty `type'outofstate L1`type'outofstate, fe exposure(avgcountypop) vce(robust)
...
disp "BASIC%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
xtpoisson monthcountyrecruit `type'monthcountydeath L1`type'monthcountydeath monthfe3-monthfe58, fe exposure(avgcountypop) vce(robust)
...
disp "OUT OF COUNTY%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
xtpoisson monthcountyrecruit `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp monthfe3-monthfe58, fe exposure(avgcountypop) vce(robust)
...
*xtpoisson active F6monthcountydeath F5monthcountydeath F4monthcountydeath F3monthcountydeath F2monthcountydeath F1monthcountydeath monthcountydeath L1monthcountydeath L2monthcountydeath L3monthcountydeath L4monthcountydeath L5monthcountydeath L6monthcountydeath L7monthcountydeath L8monthcountydeath L9monthcountydeath L10monthcountydeath L11monthcountydeath L12monthcountydeath F6outofcounty F5outofcounty F4outofcounty F3outofcounty F2outofcounty F1outofcounty outofcounty L1outofcounty L2outofcounty L3outofcounty L4outofcounty L5outofcounty L6outofcounty stateunemp countyunemp monthfe10-monthfe52, fe exposure(avgcountypop) vce(robust)
...
/*STATE TRENDS*/
*xtpoisson monthcountyrecruit `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp monthfe3-monthfe58 statetrend1-statetrend51, fe exposure(avgcountypop) vce(robust)
...
/*SHOULD I HAVE ONLY ONE UNEMP?*/
*xtpoisson monthcountyrecruit `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty countyunemp monthfe3-monthfe58 statetrend1-statetrend51, fe exposure(avgcountypop) vce(robust)
...
/*DEATH POLYNOMIAL*/
*xtpoisson monthcountyrecruit `type'monthcountydeath L1`type'monthcountydeath L1`type'monthcountydeathSQ `type'outofcounty L1`type'outofcounty L1`type'outofcountySQ stateunemp countyunemp monthfe3-monthfe58 statetrend1-statetrend51, fe exposure(avgcountypop) vce(robust)
...
foreach type in "" R { /*DO WITH BOTH ACTIVE AND TOTAL DEATHS*/
xtpoisson active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp monthfe3-monthfe33 statetrend1-statetrend51 if yearqtr<=20042&totalrec!=.&L1monthcountymort!=.&L1outofcountymort!=., fe exposure(avgcountypop) vce(robust)
...
xtpoisson active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp totalrec L1monthcountymort L1outofcountymort monthfe3-monthfe33 statetrend1-statetrend51 if yearqtr<=20042, fe exposure(avgcountypop) vce(robust)
...
*Black
 xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty /*took out avg*/deathcountyunemp deathcountypop deathPctBlack05 deathPctBush04 /*deathavgcov*/ deathRural2 stateunemp countyunemp monthfe3-monthfe58, fe exposure(avgcountypop) vce(robust)
 ...
 *Race Frac
 xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathRaceFrac deathPctBush04 deathRural2 stateunemp countyunemp monthfe3-monthfe58 if effect>0 & effect<., fe exposure(avgcountypop) vce(robust)
 ...
 *xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty stateunemp countyunemp monthfe3-monthfe58 if effect>0 & effect<., fe exposure(avgcountypop) vce(robust)
 *br fips avgcountyunemp PctBlack05 PctBush04 countypop effect if (fips==6001|fips==6037|fips==53033|fips==41051|fips==8013|fips==48329|fips==19061|fips==40003|fips==30031|fips==49049) & month==200410
 ...
 xtpoisson active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty 
  ...
  `type'deathRural2 `type'NLdeathRural2 `type'SdeathRural2 `type'SNLdeathRural2
   stateunemp countyunemp monthfe3-monthfe58, fe exposure(avgcountypop) vce(robust);
 #delimit cr
 outreg2 using ./Output/redefPinteractions`type'.txt, ct(TooMany!) bdec(3) tdec(3) bracket se append addstat(Likelihood, e(ll))
  
 /*TEST BUSH '00*/
 xtpoisson active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty `type'deathcountyunemp `type'deathcountypop `type'deathPctBlack05 `type'deathpctbush_2000 `type'deathRural2 stateunemp countyunemp monthfe3-monthfe58, fe exposure(avgcountypop) vce(robust) 
