...
xtnbreg active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty `type'outofstate L1`type'outofstate, fe exposure(countypop) vce(boot)
outreg2 `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty `type'outofstate L1`type'outofstate using ./Output/negbinom`type'.txt, ct(`file'`type'HORSERACE) append bdec(3) tdec(3) bracket se addstat(Likelihood, e(ll))

disp "BASIC%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
xtnbreg active `type'monthcountydeath L1`type'monthcountydeath monthfe3-monthfe58, fe exposure(countypop)
outreg2 `type'monthcountydeath L1`type'monthcountydeath using ./Output/negbinom`type'.txt, ct(`file'`type'Basic) addnote(negbinom`type'.txt ) append bdec(3) tdec(3) bracket se addstat(Likelihood, e(ll))

disp "OUT OF COUNTY%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
xtnbreg active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp monthfe3-monthfe58, fe exposure(countypop)
outreg2 `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp using ./Output/negbinom`type'.txt, ct(w/State) bdec(3) tdec(3) bracket se append addstat(Likelihood, e(ll))
...
/*STATE TRENDS*/
xtnbreg active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp monthfe3-monthfe58 statetrend1-statetrend51, fe exposure(countypop)
outreg2 `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty stateunemp countyunemp using ./Output/negbinom`type'.txt, ct(w/StateTrend) bdec(3) tdec(3) bracket se append addstat(Likelihood, e(ll))
 ...
 *br fips avgcountyunemp PctBlack05 PctBush04 countypop effect if (fips==6001|fips==6037|fips==53033|fips==41051|fips==8013|fips==48329|fips==19061|fips==40003|fips==30031|fips==49049) & month==200410
 ...
 /*
/*TRY IT WITH QUADRATIC INTERACTED*/
foreach var in avgcountyunemp countypop PctBlack05 PctBush04 {
 quietly gen death`var'SQ=L1monthcountydeath*`var'Z*`var'Z
 quietly gen `var'ZSQ=`var'Z*`var'Z
}
xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathPctBlack05 deathPctBush04 deathavgcountyunempSQ deathcountypopSQ deathPctBlack05SQ deathPctBush04SQ stateunemp countyunemp monthfe3-monthfe58, fe exposure(countypop) vce(robust)
 *outreg2 monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathPctBlack05 deathPctBush04 deathRural2 stateunemp countyunemp  using ./Output/redefPinteractions.txt, ct(Bunch) bdec(3) tdec(3) bracket se append addstat(Likelihood, e(ll))
 gen effectSQ=_b[L1monthcountydeath]+_b[deathavgcountyunemp]*avgcountyunempZ+_b[deathcountypop]*countypopZ + PctBlack05Z*_b[deathPctBlack05] +PctBush04Z*_b[deathPctBush04] +avgcountyunempZSQ*_b[deathavgcountyunempSQ]+countypopZSQ*_b[deathcountypopSQ]+PctBlack05ZSQ*_b[deathPctBlack05SQ] +PctBush04ZSQ*_b[deathPctBush04SQ]
 summ effectSQ
 label var effectSQ "Percentage Point Deterrent Effect of County Death by QUADRATIC Interacted County Characteristics"
 histogram effectSQ if effectSQ>-50 &effectSQ<50, title(Distribution of Quadratic Deterrent Effects)
 graph export ./Output/interactionhistoSQ.tif, replace
 disp "WITH ONLY EFFECTSQ >0"
 *xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathPctBlack05 deathPctBush04 deathavgcountyunempSQ deathcountypopSQ deathPctBlack05SQ deathPctBush04SQ stateunemp countyunemp monthfe3-monthfe58 if effectSQ>0 & effectSQ<., fe exposure(countypop) vce(robust)
 xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty stateunemp countyunemp monthfe3-monthfe58 if effectSQ>0 & effectSQ<., fe exposure(countypop) vce(robust)
 br name fips avgcountyunemp PctBlack05 PctBush04 countypop effect effectSQ if (fips==6001|fips==6037|fips==53033|fips==41051|fips==8013|fips==48329|fips==19061|fips==40003|fips==30031|fips==49049) & month==200410

/*TRY IT WITH CUBIC INTERACTED*/
foreach var in avgcountyunemp countypop PctBlack05 PctBush04 {
 quietly gen death`var'CU=L1monthcountydeath*`var'Z*`var'Z*`var'Z
 quietly gen `var'ZCU=`var'Z*`var'Z*`var'Z
}
xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathPctBlack05 deathPctBush04 deathavgcountyunempSQ deathcountypopSQ deathPctBlack05SQ deathPctBush04SQ deathavgcountyunempCU deathcountypopCU deathPctBlack05CU deathPctBush04CU stateunemp countyunemp monthfe3-monthfe58, fe exposure(countypop) vce(robust)
 *outreg2 monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathPctBlack05 deathPctBush04 deathRural2 stateunemp countyunemp  using ./Output/redefPinteractions.txt, ct(Bunch) bdec(3) tdec(3) bracket se append addstat(Likelihood, e(ll))
 gen effectCU=_b[L1monthcountydeath]+_b[deathavgcountyunemp]*avgcountyunempZ+_b[deathcountypop]*countypopZ + PctBlack05Z*_b[deathPctBlack05] +PctBush04Z*_b[deathPctBush04] +avgcountyunempZSQ*_b[deathavgcountyunempSQ]+countypopZSQ*_b[deathcountypopSQ]+PctBlack05ZSQ*_b[deathPctBlack05SQ] +PctBush04ZSQ*_b[deathPctBush04SQ] +avgcountyunempZCU*_b[deathavgcountyunempCU]+countypopZCU*_b[deathcountypopCU]+PctBlack05ZCU*_b[deathPctBlack05CU] +PctBush04ZCU*_b[deathPctBush04CU]
 summ effectCU
 label var effectCU "Percentage Point Deterrent Effect of County Death by CUBIC Interacted County Characteristics"
 histogram effectCU if effectCU>-50 &effectCU<50, title(Distribution of Cubic Deterrent Effects)
 graph export ./Output/interactionhistoCU.tif, replace
 disp "WITH ONLY EFFECTCU >0"
 *xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp deathcountypop deathPctBlack05 deathPctBush04 deathavgcountyunempSQ deathcountypopSQ deathPctBlack05SQ deathPctBush04SQ deathavgcountyunempCU deathcountypopCU deathPctBlack05CU deathPctBush04CU stateunemp countyunemp monthfe3-monthfe58 if effectSQ>0 & effectSQ<., fe exposure(countypop) vce(robust)
 xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty stateunemp countyunemp monthfe3-monthfe58 if effectCU>0 & effectCU<., fe exposure(countypop) vce(robust)
 br name fips avgcountyunemp PctBlack05 PctBush04 countypop effect effectSQ effectCU if (fips==6001|fips==6037|fips==53033|fips==41051|fips==8013|fips==48329|fips==19061|fips==40003|fips==30031|fips==49049) & month==200410


/*TRY IT WITH CATEGORICAL INTERACTED*/
foreach var in avgcountyunemp countypop PctBlack05 PctBush04 {
 xtile ptile`var'=`var', n(6)
 tab ptile`var', gen(`var'_ptile)
 foreach X in 1 2 3 4 5 6{
  gen death`var'_ptile`X'=L1monthcountydeath*`var'_ptile`X'
 }
}
xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty  stateunemp countyunemp deathavgcountyunemp_ptile2-deathavgcountyunemp_ptile6 deathcountypop_ptile2-deathcountypop_ptile6 deathPctBlack05_ptile2-deathPctBlack05_ptile6 deathPctBush04_ptile2-deathPctBush04_ptile6 monthfe3-monthfe58, fe exposure(countypop) vce(robust)
 gen effectPCT=_b[L1monthcountydeath]
 foreach var in avgcountyunemp countypop PctBlack05 PctBush04{
  foreach X in 2 3 4 5 6{
   replace effectPCT=effectPCT+_b[death`var'_ptile`X']*death`var'_ptile`X'
  }
 }
 summ effectPCT
 label var effectPCT "Percentage Point Deterrent Effect of County Death by CATEGORICAL Interacted County Characteristics"
 histogram effectPCT if effectPCT>-50 &effectPCT<50, title(Distribution of CATEGORIC Deterrent Effects)
 graph export ./Output/interactionhistoPCT.tif, replace
 disp "WITH ONLY EFFECTPCT>0"
 *xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp  stateunemp countyunemp deathavgcountyunemp_ptile2-deathavgcountyunemp_ptile6 deathcountypop_ptile2-deathcountypop_ptile6 deathPctBlack05_ptile2-deathPctBlack05_ptile6 deathPctBush04_ptile2-deathPctBush04_ptile6 monthfe3-monthfe58 if effectPCT>0 & effectPCT<., fe exposure(countypop) vce(robust)
 xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty stateunemp countyunemp monthfe3-monthfe58 if effectPCT>0 & effectPCT<., fe exposure(countypop) vce(robust)
 br name fips avgcountyunemp PctBlack05 PctBush04 countypop effect effectSQ effectCU effectPCT if (fips==6001|fips==6037|fips==53033|fips==41051|fips==8013|fips==48329|fips==19061|fips==40003|fips==30031|fips==49049) & month==200410

/*TRY IT WITH only 4 DIFFERENT PTILES*/
drop *ptile*
foreach var in avgcountyunemp countypop PctBlack05 PctBush04 {
 xtile ptile`var'=`var', n(6)
 tab ptile`var', gen(`var'_ptile)
...
xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty stateunemp countyunemp deathavgcountyunemp_ptile1-deathavgcountyunemp_ptile5 deathcountypop_ptile1-deathcountypop_ptile5 deathPctBlack05_ptile1-deathPctBlack05_ptile5 deathPctBush04_ptile1-deathPctBush04_ptile5 monthfe3-monthfe58, fe exposure(countypop) vce(robust)
 gen effectPCT2=_b[L1monthcountydeath]
 foreach var in avgcountyunemp countypop PctBlack05 PctBush04{
  foreach X in 1 2 3 4 5 {
   replace effectPCT2=effectPCT2+_b[death`var'_ptile`X']*death`var'_ptile`X'
  }
 }
 summ effectPCT2
 label var effectPCT2 "Percentage Point Deterrent Effect of County Death by 5-TILE Interacted County Characteristics"
 histogram effectPCT2 if effectPCT2>-50 &effectPCT<50, title(Distribution of CATEGORIC_2 Deterrent Effects)
 graph export ./Output/interactionhistoPCT2.tif, replace
 disp "WITH ONLY EFFECTPCT2>0"
 *xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty deathavgcountyunemp  stateunemp countyunemp deathavgcountyunemp_ptile1-deathavgcountyunemp_ptile5 deathcountypop_ptile1-deathcountypop_ptile5 deathPctBlack05_ptile1-deathPctBlack05_ptile5 deathPctBush04_ptile1-deathPctBush04_ptile5 monthfe3-monthfe58 if effectPCT2>0 & effectPCT2<., fe exposure(countypop) vce(robust)
 xtpoisson active monthcountydeath L1monthcountydeath outofcounty L1outofcounty stateunemp countyunemp monthfe3-monthfe58 if effectPCT2>0 & effectPCT2<., fe exposure(countypop) vce(robust)
 br name fips avgcountyunemp PctBlack05 PctBush04 countypop effect effectSQ effectCU effectPCT effectPCT2 if (fips==6001|fips==6037|fips==53033|fips==41051|fips==8013|fips==48329|fips==19061|fips==40003|fips==30031|fips==49049) & month==200410

 xtpoisson active `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty `type'deathcountyunemp `type'deathcountypop `type'deathRaceFrac `type'deathPctBush04 `type'deathRural2 stateunemp countyunemp monthfe3-monthfe58, fe exposure(countypop) vce(robust)
  outreg2 `type'monthcountydeath L1`type'monthcountydeath `type'outofcounty L1`type'outofcounty `type'deathcountyunemp `type'deathcountypop `type'deathRaceFrac `type'deathPctBush04 `type'deathRural2 stateunemp countyunemp  using ./Output/redefPinteractions`type'.txt, ct(RaceFrac) bdec(3) tdec(3) bracket se append addstat(Likelihood, e(ll))
